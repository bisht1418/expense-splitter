    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              The easiest way to track, split, and settle expenses with your roommates.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} RoomSplit. All rights reserved.</p>
          <div className="mt-4 md:mt-0">
            <a
              href="mailto:support@roomsplit.com"
              className="flex items-center text-gray-400 hover:text-white transition-colors text-sm"
            >
              <Mail className="h-4 w-4 mr-2" />
              support@roomsplit.com
            </a>
          </div>
        </div>
      </div>
