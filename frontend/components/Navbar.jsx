        ...
        <div className="flex justify-between h-16">
          <div className="flex">
            <div className="flex-shrink-0 flex items-center">
              <Link href="/" className="text-teal-500 font-bold text-xl">
                SplitEase
              </Link>
            </div>
            {isAuthenticated && (
              ...
              <div className="flex space-x-4">
                <Link
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium ${
                    isActive("/login") ? "bg-teal-500 text-white" : "text-gray-500 hover:bg-gray-100"
                  }`}
                >
                  Login
                </Link>
                <Link
                  href="/register"
                  className={`px-3 py-2 rounded-md text-sm font-medium ${
                    isActive("/register") ? "bg-teal-500 text-white" : "text-gray-500 hover:bg-gray-100"
                  }`}
                >
                  Register
                </Link>
